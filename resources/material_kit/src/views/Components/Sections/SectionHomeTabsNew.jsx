        ...
        <div className={classes.container}>
          <div id="nav-tabs">
            <GridContainer>
              <GridItem>
                <h3>
                  <small>Last day of Inonu Stadium by @efe</small>
                </h3>
                <CustomTabs
                  headerColor="primary"
                  tabs={[
                    {
                      ...
                      tabContent: (
                        <p className={classes.textCenter}>
                          On 11 May 2013, Beşiktaş played the last game ever played at İnönü Stadium versus Gençlerbirliği. That day was definitely a special day for most of the Beşiktaş fans, but for me it was also a rather weird but funny day. 
                          <br />
                          I don't usually go to see the games at the stadium, so it was lucky for me that my friend bought two tickets and invited me to the match. I was so excited to see the match but also on the same day, there was the kite festival of my high school. My plan was to go to the festival, leave early, then join my friend and watch the game. But the I didn't go as planned.
                          <br />
                          The kite festival was somewhere around Sarıyer but I did not quite know how to go there. I took the metro to Hacıosman and I was hoping to find my way from there. It was the first time I ever saw Hacıosman and I was a somewhat surprised by the place. It was like a small town in İstanbul, something I hadn't seen before. I was supposed to find a bus that goes to festival area. I searched around, asked some people about that bus. I found out that I had to wait a lot for the next bus and it would bee too late for me to go to the festival and then leave early. So, I decided tohead back to Beşiktaş but then it would be too early to join my friend. So I called another friend of mine we met at Gülhane Park. Just like Hacıosman, it was the first time I saw Gülhane Park.
                          <br />
                          <img src="https://www.geziyerler.com/wp-content/uploads/gulhane-parki.jpg" />
                          <br />
                          After hanging out for about an hour, I returned to Beşiktaş and joined my friend. We went to the stadium together. It was a great day for Beşiktaş and its fans. On the last game of İnönü Stadium, the home of Beşiktaş, Beşiktaş beat its opponent 3-0. Even though it was a farewell game, the atmosphere was like it was a celebration. After the final whistle, almost every Beşiktaş fan rushed into the field just  to bring a piece from good old İnönü Stadium to home and keep it. Some fans even took the seats back to their homes. Both of us being so tired, my friend and I just lived and embraced the moment and left the stadium. The day did not go as expected, but it was definitely a day to remember.
                          <br />
                          <img src="http://i.hurimg.com/i/hurriyet/75/0x0/55eaf6def018fbb8f8a218d9" />
                        </p>
                      )
                    },
                    {
